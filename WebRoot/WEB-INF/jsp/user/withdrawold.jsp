		...
		<div class="tishikuang0_1">
			...
			<div class="gao">
				...
				<div class="tu_1 right">
					...
					<input type="hiddent" name="bankName" id="encodeBankName">
				</div>
			</div>
			<div class="gao">
				...
				<div class="tu_1 right">
					...
					<input type="hiddent" name="province" id="encodeProvince">
				</div>
			</div>
			<div class="gao">
				...
				<div class="tu_1 right">
					...
					<input type="hiddent" name="city" id="encodeCity">
				</div>
			</div>
			<!-- <div class="gao">
			...
			<div class="gao">
				...
				<div class="tu_1 right">
					<input id="bankNo" name="bankNo" placeholder="请输入银行卡号" />
				</div>
			</div>
			<div class="gao">
				...
				<div class="tu_1 right">
					...
					<input type="hiddent" name="name" id="encodeName">
				</div>
			</div>
			<div class="gao">
