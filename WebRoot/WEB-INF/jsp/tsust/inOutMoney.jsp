...
<html>
	...
	<body style="margin:0 auto;">
     <div class="bt1" style="color:white;margin:0 auto;margin-bottom:20px;"><span>出入金</span>
       ...
       <img style="float:right;margin-top:15px;padding-right:20px;" src="<%=basePath %>images/back.png"/></a> 
		...
		<div style="width:50%;float: left;height:30px;line-height:30px;" class="title_div">操作&nbsp;&nbsp;&nbsp;&nbsp;</div>
		<div style="width:16%;float: left;height:30px;line-height:30px;" class="title_div">金额</div></div>
